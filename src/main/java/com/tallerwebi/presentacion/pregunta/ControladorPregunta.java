...
public class ControladorPregunta {
  ...
  private static final String REDIRECT_PREGUNTAS = "redirect:/admin/preguntas";
  ...
  public String eliminarPregunta(@RequestParam(required = false) Long id, HttpSession session) {
    // verificar admin
    if (!sessionUtil.verificarAdmin(session)) {
      return REDIRECT_LOGIN;
    }
